 ...
 * @author HoxPJ
 */
@WebServlet(name = "PegaXML", urlPatterns = {"/PegaXML"})
public class PegaXML extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            documentXML.serealizar(out,  documentXML.getDoc());
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(PegaXML.class.getName()).log(Level.SEVERE, null, ex);
